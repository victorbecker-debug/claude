...
// Colors follow the dark premium "silver + graphite" palette approved for
// the app's visual direction: muted, desaturated tones (platinum, bronze,
// dusty teal/blue/mauve/sage) rather than bright saturated hues. Categories
// beyond the top 6 fold into "Outros" (dark graphite) when charted — see
